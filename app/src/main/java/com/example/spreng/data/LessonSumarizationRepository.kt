...
class DemoLessonSummarizationRepository : LessonSummarizationRepository {
    override fun getAllLessonSummarization(): List<LessonSummarizationForm> {
        return listOf(
            ...
            LessonSummarizationForm(2, "Vehicle", "Explore different types of vehicles, their uses, and maintenance tips", true, 2),
            ...
            LessonSummarizationForm(4, "Food", "Discover popular dishes from around the world and their cultural significance", true, 1),
            LessonSummarizationForm(5, "Culture", "Understand the diverse cultures around the world and their unique traditions", false,),
            LessonSummarizationForm(6, "History", "Learn about important historical events and their impact on the present", false, 2),
            LessonSummarizationForm(7, "Technology", "Stay updated with the latest advancements in technology and their applications", false,),
            LessonSummarizationForm(8, "Health", "Maintain a healthy lifestyle with tips on diet, exercise, and mental well-being", false,),
