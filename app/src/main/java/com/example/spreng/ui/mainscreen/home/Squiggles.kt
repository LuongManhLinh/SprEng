...
fun RebuildingSinaSquiggles() {
    ...
    Canvas(
        ...
        clipRect {
            drawPath(path = path, color = Color.Red, style = Stroke(width = 15f, cap = StrokeCap.Round))
            if (showPoints) {
                points.forEach {
    ...
    SprEngTheme {
        Column(
            ...
            Column(
                ...
                Text(text = "Bezier Curves", color = Color.Green, fontSize = 16.sp)
                Box(
            ...
            Column(
                ...
                Text(text = "Sin Wave", color = Color.Green, fontSize = 16.sp)
                Box(
                    modifier = Modifier.fillMaxWidth(),
                    contentAlignment = Alignment.Center
                ) {
            ...
            Column(
                ...
                Text(text = "Line + Stamp Path Effect", color = Color.Green, fontSize = 16.sp)
                Box(
                    modifier = Modifier.fillMaxWidth(),
                    contentAlignment = Alignment.Center
                ) {
